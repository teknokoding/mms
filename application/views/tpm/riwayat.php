          ...
          <?php foreach ($riwayat as $item1) {
            ...
            <div class="time-label">
              ...
              <div>
                ...
                <div class="timeline-item">
                <span class="time"></span>
                  <h3 class="timeline-header"><a href="#"><?=$item1->nama_mesin;?></a> :: <?=$item1->nama_unitmesin;?></h3>
            ...
            {?>
              ...
              <div>
                ...
                <div class="timeline-item">
                  <span class="time"></span>
                  <h3 class="timeline-header"><a href="#"><?=$itemriwayat->nama_karyawan;?></a> melakukan release</h3>
                  <div class="timeline-body">
                    <?=$itemriwayat->action;?>
                  </div>
                  <div class="timeline-footer">
