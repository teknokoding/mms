...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url();?>assets/dist/img/mms.png">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-danger">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-sm-inline-block">
        <a href="#" class="nav-link"><b>MMS V3.0 - Sistem Monitor</b></a>
      </li>
    </ul>
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
    <li class="nav-item">
        <a class="nav-link" href="<?=base_url('monitor/scaner/').$id_mesin;?>" role="button">
    ...
    if (isset($id_mesin)) {
        ?>
    <li class="nav-item">
        <a class="nav-link" href="<?=base_url('monitor/qr/').$id_mesin; ?>" role="button">
  ...
  <!-- /.navbar -->
  <audio id="ChatAudio" src="<?php echo base_url('assets/dist/audio/') ?>notif.mp3">
      Your browser does not support the audio element.
    </audio>
    <audio id="LogoutAudio" src="<?php echo base_url('assets/dist/audio/') ?>logout.mp3">
      Your browser does not support the audio element.
    </audio>
  <script>
