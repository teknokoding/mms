...
<head>
  <meta charset="utf-8">
  <title>SPK Bengkel SPK-CWTD-<?php echo date('my')."-".$itemsingle->id_spkbk;?></title>
...
<table class="table">
	<tbody>
		<tr>
			...
			<b>SURAT PERINTAH KERJA<br>
				No. SPK/CWTD/<?php echo date('my')."-".$itemsingle->id_spkbk;?></b>
			</td>
		</tr>
		<tr>
	...
	<table class="table">
		...
		<tr>
			...
			<tr>
			<td>
				<br><b>Technical Development Superintendent</b><br>
  ...
  Atas bantuan dan kerjasamanya kami ucapkan terimakasih.
	...
	<table class="table" style="align:center; cellpadding:4">
		<tr>
			<td style="width:75%">
...
var opt = {
  filename:     'SPK-CWTD-<?=$item->id_spkbk;?>',
  html2canvas:  { scale: 3 }
};
