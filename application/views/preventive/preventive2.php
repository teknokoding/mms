        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-header">
                ...
                <div class="row">
                <div class="col-md-8">
                <h5>Jadwal Perawatan <?=date('d M Y');?></h5>
                </div>
                ...
                <button id="create_cl" class="btn btn-sm btn-success"><i class="far fa-edit"></i> Buat Jadwal</button>&nbsp;
                </div>
                </div>
                </div>
                 <!-- ROW -->
...
if($itembulanan->skip_cl!='1'){
  $done_skip = "<div title='$itembulanan->done_cl' id_jadwal_cl='$itembulanan->id_jadwal_cl' class='cek_cl icheck-primary d-inline'>
  <input type='checkbox' $cek>
  <label>
  </label>
  </div>";}
...
if($itemindependen->skip_cl!='1'){
  $done_skip = "<div title='$itemindependen->done_cl' id_jadwal_cl='$itemindependen->id_jadwal_cl' class='cek_cl icheck-primary d-inline'>
  <input type='checkbox' $cek>
  <label>
  </label>
  </div>";}
...
{
$("#input_cl").load('<?=base_url('preventive/create_form');?>'); 
}
);
$(".cek_cl").tooltip();
});
