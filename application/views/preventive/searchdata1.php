          ...
          <div class="card">
            <div class="card-header">
              <div class="card-tool">
                ...
                <div class="row">
                  <div class="col-md-8">
                    <h5>Data Preventive <?=date('d M Y', strtotime($mulai))?>
                      s/d <?=date('d M Y', strtotime($selesai))?>
                    </h5>
                  </div>
                  <div class="col-md-4" id="tool-button">
                    <div class="float-right">
                      ...
                      <a
                        href="<?= base_url('preventiveday'); ?>"><button
                          class="btn btn-sm btn-success"><i class="far fa-calendar"></i> Jadwal Hari Ini</button></a>
                      &nbsp;
                    </div>
                  </div>
                </div>
