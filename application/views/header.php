    ...
    <nav class="main-header navbar navbar-expand navbar-dark navbar-lightblue">
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-sm-inline-block">
          <a href="#" class="nav-link">MMS V3.0 &nbsp;&nbsp;<span class="badge badge-warning"><?=$this->session->userdata('judul');?></span></a>
        </li>
      </ul>
      <!-- Right navbar links -->
	  ...
	  <li class="nav-item">
          <a class="nav-link"
            href="#"
            role="button">
			<span id="JamSekarang" class="badge d-none d-md-block"> </span>
			</a>
        </li>
        ...
        <li class="nav-item">
          <a title="Akses Cepat" class="judul nav-link" data-widget="control-sidebar" data-slide="true" href="#"
...
var timestamp = '<?=time();?>';
function updateTime(){
  $('#JamSekarang').html(moment(Date(timestamp)).format("D MMMM YYYY HH:mm:ss"));
  timestamp++;
}
$(function(){
