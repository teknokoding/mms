<!-- <a id="back-to-top" href="#" class="btn btn-danger btn-sm back-to-top" role="button" aria-label="Scroll to top">
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-body">
        <p>
          <b><?= $this->session->userdata('namalengkap'); ?></b>, yakin ingin keluar dari aplikasi?<br>
          Pastikan tidak ada transaksi aktif yang sedang anda lakukan&hellip;</p>
      </div>
...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <center><strong>&copy; 2023 <a href="http://www.gramediaprinting.com">Gramedia Printing Bandung</a>.</strong><br><small>develop by @bianbudiawan</small></center>
  </footer>
</div>
<!-- ./wrapper -->
