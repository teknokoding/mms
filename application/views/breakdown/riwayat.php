  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#"><?=$itemriwayat->namalengkap;?></a> membuat laporan
                  </h3>
                  <div class="timeline-body">
                    <?=$itemriwayat->uraian;?>
                  </div>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a
          href="<?=base_url('lkh/createnext/').$itemriwayat->reff_id;?>"><button
            class='btn btn-sm btn-success'><i class='far fa-arrow-alt-circle-right'></i>&nbsp;Lanjutkan</button></a>
        <?php }?>
      </div>
    </div>
    <!-- /.modal-content -->
