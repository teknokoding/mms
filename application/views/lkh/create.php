      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="POST" action="<?= base_url('lkh/input');?>">
              ...
              <input type="hidden" name="reff_id" value="">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                      <input name="waktumulai" type="time" class="form-control form-control-sm jammask" placeholder="Mulai" data-inputmask="'mask': '99:99'" required>
                    </div>

                    <div class="col-sm-1">
                      <input name="waktuselesai" type="time" class="form-control form-control-sm jammask" placeholder="Selesai" data-inputmask="'mask': '99:99'" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <!-- DETAIL LOKASI -->
                    <div class="col-sm-2">
                      <input id="detail" name="detail" type="text" class="form-control form-control-sm" placeholder="Detail Lokasi">
                    </div>
                  </div>
                  <!-- KEGIATAN -------->
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input id="keluhan" name="keluhan" type="text" class="form-control form-control-sm" placeholder="" autocomplete="off">
                    </div>
                  </div> 
                  <!-- URAIAN KERJA -------->
                  <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    { $item->username==$this->session->userdata('username')?$pilih="selected":$pilih="";
                      echo '<option value="'.$item->username.'", '.$pilih.'>'.$item->namalengkap.'</option>';}
                    ?>
                    </select>
                  </div> 
                </div> 
...
$.ajax({
        ...
        success: function(hasil) {
          ...
          $.each(unitmesin, function(i, item) {
            $('#id_unit_mesin').append('<option value="'+unitmesin[i].id_unitmesin+'">'+unitmesin[i].nama_unitmesin+'<td></td></option>');
          }); 
        }
      });
    });
